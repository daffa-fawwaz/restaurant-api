...
export const createMidtransPayment = async (req, res) => {
    try {
        ...
        return error(res, 500, "Gagal membuat pembayaran", err instanceof Error ? err.message : "INTERNAL_SERVER_ERROR");
    }
};
export const midtransNotification = async (req, res) => {
    try {
        ...
        return error(res, 500, "Gagal memproses notification", err instanceof Error ? err.message : "INTERNAL_SERVER_ERROR");
    }
};
export const finishMidtransPayment = async (req, res) => {
    try {
        ...
        return error(res, 500, "Gagal menyelesaikan pembayaran", err instanceof Error ? err.message : "INTERNAL_SERVER_ERROR");
    }
};
export const cancelPendingPayment = async (req, res) => {
    try {
        ...
        return error(res, 500, "Gagal membatalkan pembayaran pending", err instanceof Error ? err.message : "INTERNAL_SERVER_ERROR");
    }
};
